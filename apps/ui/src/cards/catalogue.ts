...
export const CARDS: Card[] = [
  ...
  },
  {
    ...
    category: 'attack',
    deck: 'base',
    art: B('Attack 3 - 7 qty.png'),
    tags: ['lightning', 'sudo'],
    qty: 7,
  },
  {
    id: 'attack-legacy-code',
    name: 'Legacy Code',
    category: 'attack',
    deck: 'base',
    art: B('Attack 4 - 3 qty.png'),
    tags: ['lightning', 'sudo'],
    qty: 3,
  },
  {
    id: 'attack-out-of-memory',
    name: 'Out of Memory',
    category: 'attack',
    deck: 'base',
    art: B('Attack 5 - 2 qty.png'),
    tags: ['lightning', 'sudo'],
    qty: 2,
  },
  ...
  // ===== Protection =====
  {
    ...
    category: 'protection',
    deck: 'base',
    art: B('Protection 1 - 4 qty.png'),
    tags: [],
    qty: 4,
  },
  {
    id: 'protection-debugger',
    name: 'Debugger',
    category: 'protection',
    deck: 'base',
    art: B('Protection 2 - 8 qty.png'),
    tags: [],
    qty: 8,
  },
  ...
  // ===== Operation (Git) =====
  {
    ...
    category: 'operation',
    deck: 'base',
    art: B('Operation 1 - 2 qty.png'),
    tags: ['sudo'],
    qty: 2,
  },
  {
    id: 'operation-git-merge',
    name: 'Git Merge',
    category: 'operation',
    deck: 'base',
    art: B('Operation 2 - 2 qty.png'),
    tags: ['sudo'],
    qty: 2,
  },
  {
    id: 'operation-git-branch',
    name: 'Git Branch',
    category: 'operation',
    deck: 'base',
    art: B('Operation 3 - 3 qty.png'),
    tags: ['sudo'],
    qty: 3,
  },
  {
    id: 'operation-git-rebase',
    name: 'Git Rebase',
    category: 'operation',
    deck: 'base',
    art: B('Operation 4 - 3 qty.png'),
    tags: ['sudo'],
    qty: 3,
  },
  {
    id: 'operation-git-cherry-pick',
    name: 'Git Cherry-pick',
    category: 'operation',
    deck: 'base',
    art: B('Operation 5 - 3 qty.png'),
    tags: ['sudo'],
    qty: 3,
  },
  ...
  // ===== AI / Events (фиолетовая колода) =====
  {
    ...
    category: 'ai',
    deck: 'ai',
    art: A('AI 1 - purple cover - 2 qty.png'),
    tags: ['ai'],
    qty: 2,
  },
  {
    id: 'ai-crush-frontend',
    name: 'Crush Frontend',
    category: 'ai',
    deck: 'ai',
    art: A('AI 2 - purple cover - 2 qty.png'),
    tags: ['ai'],
    qty: 2,
  },
  {
    ...
    category: 'ai',
    deck: 'ai',
    art: A('AI 3 - purple cover - 2 qty.png'),
    tags: ['ai'],
    qty: 2,
  },
  {
    ...
    category: 'ai',
    deck: 'ai',
    art: A('AI 4 - purple cover - 2 qty.png'),
    tags: ['ai'],
    qty: 2,
  },
  {
    id: 'ai-release-database',
    name: 'Release Database',
    category: 'ai',
    deck: 'ai',
    art: A('AI 5 - purple cover - 1 qty.png'),
    tags: ['ai'],
    qty: 1,
  },
  {
    id: 'ai-release-frontend',
    name: 'Release Frontend',
    category: 'ai',
    deck: 'ai',
    art: A('AI 6 - purple cover - 1 qty.png'),
    tags: ['ai'],
    qty: 1,
  },
  {
    id: 'ai-release-backend',
    name: 'Release Backend',
    category: 'ai',
    deck: 'ai',
    art: A('AI 7 - purple cover - 1 qty.png'),
    tags: ['ai'],
    qty: 1,
  },
  {
    id: 'ai-good-vibe-coding',
    name: 'Good Vibe-Coding',
    category: 'ai',
    deck: 'ai',
    art: A('AI 8 - purple cover - 3 qty.png'),
    tags: ['ai'],
    qty: 3,
  },
  {
    id: 'ai-bad-vibe-coding',
    name: 'Bad Vibe-Coding',
    category: 'ai',
    deck: 'ai',
    art: A('AI 9 - purple cover - 2 qty.png'),
    tags: ['ai'],
    qty: 2,
  },
  {
    ...
    category: 'ai',
    deck: 'ai',
    art: A('AI 10 - purple cover - 2 qty.png'),
    tags: ['ai'],
    qty: 2,
  },
  {
    ...
    category: 'ai',
    deck: 'ai',
    art: A('AI 11 - purple cover - 2 qty.png'),
    tags: ['ai'],
    qty: 2,
  },
  {
    ...
    category: 'ai',
    deck: 'ai',
    art: A('AI 12 - purple cover - 1 qty.png'),
    tags: ['ai'],
    qty: 1,
  },
]
