...
- **All text goes through `<Typography>` from `@release/ui`** — never Tailwind font/size/tracking utilities on text. Full rule: [apps/ui/CLAUDE.md](../ui/CLAUDE.md#typography-rule).
